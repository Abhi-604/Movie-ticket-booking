...
void change_seat_booking_status(int seat_number,char *,struct tm);

char* get_ticket_id(user*);
void change_seat_booking_status(int,char*,struct tm);
int cancel_booking_of_user(user*);
void show_booking_of_user_(user *);
void delete_booking_of_user(user *);
